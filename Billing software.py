...
class Bill_App:
    def __init__(self,root):
        ...
        self.root.title("Yash Super Market")
        bg_color="#074463"
        title=Label(self.root,text="Yash Super Market",bd=12,relief=GROOVE,bg=bg_color,fg="white",font=("times new roman",30,"bold"),pady=2).pack(fill=X)
        #=================Variables==========#
        #==============Cosmetics=============#
        self.soap=IntVar()
        ...
        H_g_lbl=Label(F2,text="Hair Gel",font=("times new roman",16,"bold"),bg=bg_color,fg="lightgreen").grid(row=4,column=0,padx=10,pady=10,sticky="w")
        H_g_txt=Entry(F2,width=10,textvariable=self.gel,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=4,column=1,padx=10,pady=10)
        ...
        g3_lbl=Label(F3,text="Dal",font=("times new roman",16,"bold"),bg=bg_color,fg="lightgreen").grid(row=2,column=0,padx=10,pady=10,sticky="w")
        ...
        #==============Cold drinks Frame=============#
        F4=LabelFrame(self.root,bd=10,relief=GROOVE,text="Cold Drink",font=("times new roman",15,"bold"),fg="yellow",bg=bg_color)
        ...
        F5.place(x=1010,y=177,width=340,height=380)
        ...
        m3_txt=Entry(F6,width=18,font="arial 10 bold",textvariable=self.cold_drinks_price,bd=7,relief=SUNKEN).grid(row=2,column=1,padx=10,pady=1)
        ...
        total_btn=Button(btn_F,command=self.total,text="Total",bg="cadetblue",fg="white",bd=2,pady=15,width=9,font="arial 17 bold").grid(row=0,column=0,padx=5,pady=5)
        GBill_btn=Button(btn_F,text="Gen Bill",command=self.bill_area,bg="cadetblue",fg="white",bd=2,pady=15,width=9,font="arial 17 bold").grid(row=0,column=1,padx=5,pady=5)
        Clear_btn=Button(btn_F,text="Clear",command=self.clear_data,bg="cadetblue",fg="white",bd=2,pady=15,width=9,font="arial 17 bold").grid(row=0,column=2,padx=5,pady=5)
        Exit_btn=Button(btn_F,text="Exit",command=self.Exit_app,bg="cadetblue",fg="white",bd=2,pady=15,width=9,font="arial 17 bold").grid(row=0,column=3,padx=5,pady=5)
        self.welcome_bill()
    ...
    def bill_area(self):
        ...
        elif self.total_cosmetic_price=="Rs. 0.0" and self.total_grocery_price=="Rs. 0.0" and self.total_drinks_price=="Rs. 0.0":
    ...
    def clear_data(self):
        op=messagebox.askyesno("Clear","Do you really wnat to clear data?")
